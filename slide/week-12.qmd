...
### 📋 Head to Canvas and complete A1 (Section 1: The Fundamental Problem)

- [Link to A1](http://10.121.89.203:3838/week-12-inclass-causal-dags-01)
...
### 📋 Head to Canvas and complete A1 (Section 2: Directed Acyclic Graphs (DAGs))
...
![](../img/menti_week_12.png)


## How to measure significant in difference among groups

Let's read this methods description from a paper (Paper is in Canvas)
...
[LINK to PAPER](https://canvas.sydney.edu.au/courses/71706/files/50012947?module_item_id=3108125)
...
## Estimating the Treatment Effect {.smaller}
...
### 📋 Head to Canvas and complete A1 (Section 3: Propensity Score Matching)
...
(Canvas doesn't allow saving new pages)

- [Link to A2](http://10.121.89.203:3838/week-12-outofclass-practice-01)
