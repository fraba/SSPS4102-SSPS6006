...
## Week 11 Student feedback survey
...
## Mentimeter: Checking on your A4

![](../img/menti_week_11.png)
...
### 📋 Head to Canvas and complete A1 (Section 1-2: Randomised Controlled Trials Basics)
...
> Research equipoise is the ethical requirement that genuine uncertainty exists within the expert community regarding which treatment is superior in a clinical trial. It justifies randomising participants to different interventions, ensuring that patients are not denied superior care for the sake of research.

This is also relevant when assessing policy interventions
...
## In Australia, Human Research is regulated by the National Statement on Ethical Conduct in Human Research

- You can access the guidelines [here](https://www.nhmrc.gov.au/about-us/publications/national-statement-ethical-conduct-human-research-2023#block-views-block-file-attachments-content-block-1)

- You have guidelines also for animal research. 
...
### 📋 Head to Canvas and complete A1 (Section 3: Research Ethics and Validity)
...
Never skip ethics review! All university research involving human participants requires approval. Moreover, academic journals are often requiring you to provide evidence of approval of your ethics application. 
:::
...
### 📋 Head to Canvas and complete A1 (Section 4: Survey Design Principles)
...
- Full example [here](https://avehtari.github.io/ROS-Examples/Poststrat/poststrat2.html)
