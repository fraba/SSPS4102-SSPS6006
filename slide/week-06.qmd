...
- ${\hat{y}}_{i}$ is the predicted value for observation $i$
- $e_{i} = y_{i} - \hat{y}_{i}$ is the **residual** (prediction error)
...
### 📋 Head to Canvas and complete A1 (Section 1: Understanding Best-Fit Lines)
...
### 📋 Head to Canvas and complete A1 (Section 2: Fitting Models with lm())
...
### 📋 Head to Canvas and complete A1 (Section 3: Coefficients as Comparisons)
...
This comes from the normal distribution properties we learned last week.
...
### 📋 Head to Canvas and complete A1 (Section 4:  Assessing Model Quality)
