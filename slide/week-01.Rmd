...
I am a Lecturer in the School of Social and Political Sciences, University of Sydney. I am also the [Deputy Director of the Centre for AI, Trust and Governance](https://www.sydney.edu.au/arts/our-research/centres-institutes-and-groups/centre-for-ai-trust-and-governance.html).

I am interested in researching forms of political engagement and political talk on social media. I researched the emergence and dynamics of online communities, the role between news organisations and social media, and the interdependence between social media activists and news organisations. I have engaged with and applied quantitative research methods developing expertise in quantitative text analysis (NLP) and network analysis.

This year I am teaching GOVT6139 (S2), SSPS4102 & SSPS6006 (S1) and GOVT3901 (S1).
...
|---------------|------------------------------------------------------------------------------------------------|
| 14:00 - 14:40 | Unit's introduction and overview: Textbook and texts; Content; Learning goals; How to do this  |
| 14:40 - 15:00 | Getting started with R and RStudio                                                             |
| 15:00 - 15:15 | Individual quiz/tutorial Part 1                                                                |
| 15:15 - 15:45 | Stats: Data & Datasets, Variables, Mean                                                        |
| 15:45 - 16:00 | Break                                                                                          |
| 16:00 - 16:15 | Individual quiz/tutorial Part 2                                                                |
| 16:15 - 17:00 | Group problem set (if we have time)                                                            |
...
# Student feedback form 2023 and 2024: What students liked 

- **Engaging & Supportive Teaching** – The unit organisation and available support were widely appreciated.
- **Valuable Skills Development** – Coding in R and statistical literacy were seen as useful for the workforce.
- **Practical & Real-World Applications** – Students enjoyed connections to real-world data and examples.
- **Challenging but Rewarding** – Many found the unit tough but felt well-supported throughout.
...
### 💬 Student Quotes
> _"This unit was incredibly helpful with statistical literacy. I feel much more comfortable interpreting statistics and discussing these concepts."_

> _"Francesco was a very supportive tutor who was always willing to help us as much as he could. His positive attitude was possibly the only thing that kept me going through this subject, as it was very hard."_

> _"Learning how to code is important, so I have enjoyed learning this. The structure of class and the R-Studio quizzes were helpful."_

> _"I enjoyed learning how to use a new program, despite the difficulties of it. I also quite enjoyed the assessment tasks."_

> _"This has been an entirely new skill for me to develop, which was useful and applicable within the workforce."_

✅ **Overall:** A challenging but rewarding unit that helped students build essential data analytics skills with strong teaching support.

---

# What students didn't like: Areas for Improvement

1. **Course Pace & Difficulty** – The fast pace was challenging.

2. **Class Structure & Timing** – The 3-hour seminar format was considered long and difficult to stay engaged in.

3. **Coding Integration** – Students suggested better integration between code and theory (statistical but also research design theory).
...
.center[https://canvas.sydney.edu.au/courses/64208]
...
.center[https://canvas.sydney.edu.au/courses/64400]


---

## Let's talk about... GenAI (1/3)
...
## Week 01 Group problem set (in class)
